...
const handleStone = async (req, res, stone) => {
  const products = await Product.find({ stones: stone })
    .populate("category", "_id name")
    .populate("subs", "_id name")
    .populate("postedBy", "_id name")
    .exec();
...
const handleGemstoneComposition = async (req, res, gemstoneComposition) => {
  const products = await Product.find({ gemstoneComposition })
    .populate("category", "_id name")
    .populate("subs", "_id name")
    .populate("postedBy", "_id name")
    .exec();
...
exports.searchFilters = async (req, res) => {
  ...
  if (gemstoneComposition) {
    console.log("gemstoneComposition ---> ", gemstoneComposition);
    await handleGemstoneComposition(req, res, gemstoneComposition);
  }
};
